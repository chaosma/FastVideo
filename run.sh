...
# Memory probe (jd's commits): rank-0 only by default --- FSDP makes
# ranks symmetric, and per-phase syncs would perturb step time.
MEM_PROBE_ENABLE=${MEM_PROBE_ENABLE:-1}
MEM_PROBE_DIR=${MEM_PROBE_DIR:-logs/mem_probe_8xh200_121f}
