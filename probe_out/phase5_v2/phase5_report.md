...
| # | Check | Result | Detail |
|---|---|---|---|
| 1 | `streaming_pytest_passes` | ✅ PASS | pytest exit code = 0 (expected 0; pytest.log at /workspace/FastVideo/probe_out/phase5_v2/pytest.log) |
| 2 | `probe_full_completed` | ✅ PASS | exit=0, phase_memory entries=2, last loss=4.37494421005249 |
| 3 | `probe_full_offload_completed` | ✅ PASS | exit=0, phase_memory entries=2, last loss=4.373788356781006 |
| 4 | `probe_streamed_offload_completed` | ✅ PASS | exit=0, phase_memory entries=2, last loss=4.376796722412109 |
...
| 7 | `streamed_vs_full_offload_loss_match` | ✅ PASS | step 2: full_offload=4.3737884, streamed=4.3767967, diff=3.01e-03 (tol=5e-03) |
| 8 | `streamed_step_time_within_budget` | ✅ PASS | FULL_OFFLOAD step 2 = 2.32s; STREAMED_OFFLOAD step 2 = 2.26s; ratio = 0.97 (limit 1.20) |
